...
module.exports.run = async function({ api, event, args }) {
	...
	let sex = threadInfo.approvalMode;
			...
			var callback = () =>
				api.sendMessage(
					{
						body: `🔧 GC Name: ${threadName}\n🔧 Group ID: ${id}\n🔧 Approval: ${pd}\n🔧 Emoji: ${icon}\n🔧 Information: including ${threadMem} members\n🔧 Number of males: ${nam} members\n🔧 Number of females: ${nu} members\n🔧 With ${qtv} administrators\n🔧 Total number of messages: ${sl} msgs.\n\nMade with ❤️ by:  💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞𝗝𝗔𝗚𝗗𝗘𝗘𝗣☜ 💫\n
🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 〠𝗝𝗔𝗚𝗗𝗘𝗘𝗣🖤\n

😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ www.facebook.com/profile.php?id=100020241115864\n

👋For Any Kind Of Help Contact On Telegram  Username 👉 @Jagdeep😇`,

module.exports.config = {
    ...
    version: "7.3.1",
    hasPermssion: 0,
    credits: "Jagdeep singh",///don't change my Credit Coz i Edit 
...
async function makeImage({ one, two }) {
    ...
    batgiam_img.composite(circleOne.resize(300, 100), 740, 300).composite(circleTwo.resize(360, 342), 98, 95);

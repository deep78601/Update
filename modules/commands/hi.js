...
module.exports.handleEvent = async ({ event, api, Users }) => {
  ...
  if (typeof thread["hi"] == "undefined", thread["hlo"] == false) return
  else {
  if (KEY.includes(event.body.toLowerCase()) !== false) {
    ...
    hours > 1001 && hours <= 1200 ? "morning" : 
    hours > 1201 && hours <= 1700 ? "morning, Nashta hua" : 
    hours > 1701 && hours <= 1800 ? "gloaming" : 
    hours > 1801 && hours <= 2100 ? "evening" : 
    hours > 2101 && hours <= 2400 ? "Good Evening baby😘" : 
    "error");

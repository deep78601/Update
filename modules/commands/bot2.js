...
//JO COMMAND CHANGE KREGA USKI BEHN PREM KI RAKHEL HOGI 
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "koi h") || (event.body.toLowerCase() == "koi hai") || (event.body.toLowerCase() == "koi haga") || (event.body.toLowerCase() == "koi hai kya")) {
     return api.sendMessage("मैं हूं ना जानेमन 🙂🤟", threadID);
   };

    if ((event.body.toLowerCase() == "call a") || (event.body.toLowerCase() == "call") || (event.body.toLowerCase() == "call aaja") || (event.body.toLowerCase() == "Coll")) {
     return api.sendMessage("मैं कैसे कॉल आऊं मैं तो बोट हूं 😒👈", threadID);
   };

   if ((event.body.toLowerCase() == "kiya kar rahe ho") || (event.body.toLowerCase() == "ki kard")) {
  ...
  if ((event.body.toLowerCase() == "🥵") || (event.body.toLowerCase() == "🥵🥵") || (event.body.toLowerCase() == "🥵🥵🥵") || (event.body.toLowerCase() == "🥵🥵🥵🥵")) {
   ...
   if ((event.body.toLowerCase() == "acha") || (event.body.toLowerCase() == "acha ji") || (event.body.toLowerCase() == "acha g") || (event.body.toLowerCase() == "oo acha ji")) {
     return api.sendMessage("हांजी  😒👈", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "kya hua") || (event.body.toLowerCase() == "kiya hua") || (event.body.toLowerCase() == "ki hoya") || (event.body.toLowerCase() == "kiya hua")) {
     return api.sendMessage("कुछ नही  😒👈", threadID);
   };
  
   mess = "{name}"   //THIS BOT IS MADE BY JAGDEEP SINGH
  
  if (event.body.indexOf("Deep") == 0 || (event.body.indexOf("BOT") == 0)) {
    var msg = {
      body: `✧════•❁${name}❁•════✧\n\n ${rand} \n\n                       ◦•●◉✿𝗝𝗔𝗚𝗗𝗘𝗘𝗣✿◉●•◦`
    }

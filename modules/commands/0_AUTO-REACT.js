...
module.exports.config = {
	...
	version: "1.1.1",
	hasPermission: 0,
	credits: "JAGDEEP SINGH", /////@jagdeep-singh3608
	description: "THIS BOT IS JAGDEEP SINGH",
...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
    ...
    if(react.includes("JAN") || react.includes("jan") || react.includes("JANU") || react.includes("JANI") || react.includes("Jani") || react.includes("jani") || react.includes("😊") || react.includes("iloveyou") || react.includes("ILOVEU") || react.includes("Iloveu") || react.includes("love") || react.includes("LOVE") || react.includes("lOVE") || react.includes("Uff") || react.includes("uff") || react.includes("UFFF") || react.includes("Pragnent") || react.includes("PRAGNENT") || react.includes("pragnent") || react.includes("BABY") || react.includes("baby") || react.includes("baby") || react.includes("BABE") || react.includes("Babe") || react.includes("babe") || react.includes("SHONA") || react.includes("Shona") || react.includes("shona") || react.includes("babu") || react.includes("BABU") || react.includes("babu") || react.includes("😙") || react.includes("😘") || react.includes("😚") || react.includes("Janu") || react.includes("JANU") || react.includes("Janu") || react.includes("Sweet") || react.includes("sweet") || react.includes("SWEET") || react.includes("always") || react.includes("Always") || react.includes("ALWAYS") || react.includes("Awww") || react.includes("AWW") || react.includes("CHUMI") || react.includes("chumi") || react.includes("Chumi") || react.includes("Puppy") || react.includes("puppy") || react.includes("PUPPY") || react.includes("Deep") || react.includes("pending") || react.includes("+") || react.includes("🥰") || react.includes("😍") || react.includes("🤩") || react.includes("😉") || react.includes("❤️") || react.includes("🤭") || react.includes("😍") || react.includes("☺️") || react.includes("🤍") || react.includes("🖤") || react.includes("💝") || react.includes("💞") || react.includes("💕") || react.includes("🌹") || react.includes("🙈") || react.includes("🌷") || react.includes("💋") || react.includes("🌍") || react.includes("🍫") || react.includes("🎈") || react.includes("🎁") || react.includes("🍕") || react.includes("🍛") || react.includes("Mery Jan") || react.includes("MERY JAN") || react.includes("mery jan") || react.includes("My") || react.includes("my") || react.includes("MY") || react.includes("wife") || react.includes("Wife") || react.includes("WIFE") || react.includes("HUBBY") || react.includes("hubby") || react.includes("Hubby") || react.includes("Cute") || react.includes("CUTE") || react.includes("cute") || react.includes("WAO") || react.includes("Wao") || react.includes("wao") || react.includes("boobs") || react.includes("BOOBS") || react.includes("finger") || react.includes("Finger") || react.includes("fifinger") || react.includes("BOOBS") || react.includes("chut") || react.includes("handsome") || react.includes("Handsome") || react.includes("HANDSOME") || react.includes("beautiful") || react.includes("Beautiful") || react.includes("BEAUTIFUL") || react.includes("ummaah") || react.includes("UMAAAH") || react.includes("Ummmmah") || react.includes("UMMMMCH") || react.includes("UMMMCH") || react.includes("ummmmch")) {
      var lab = {
				body: ""
			}
    ...
    if(react.includes("Satnam waheguru ji") || react.includes("waheguru") || react.includes("ram ram") || react.includes("jai sheri ram") || react.includes("waheguru ji") || react.includes("ਵਾਹਿਗੁਰੂ ਜੀ ") || react.includes("Waheguru ji") || react.includes("Wmk")) {
      var sad = {
				body: "WAHEGURU JI 🙏"
			}
			api.sendMessage(sad, threadID, messageID);
    ...
    if(react.includes("teri bhen di") || react.includes("teri maa di") || react.includes("teri bhen ki") || react.includes("bot teri bhen") || react.includes("bot teri maa") || 
react.includes("teri bhen da") || 
react.includes("teri maa da") || 
react.includes("bot teri bhen")) {
      var sad = {
				body: "ABE OYE ABUSE NA KR 👿"
			}
			api.sendMessage(sad, threadID, messageID);
    api.setMessageReaction("👿", event.messageID, (err) => {}, true)
          };
